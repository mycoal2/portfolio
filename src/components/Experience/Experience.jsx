...
const Experience = () => {
  return (
    <section className="bg-primary px-4 text-white py-12" id="experience">
      ...
      <div className="w-full flex space-x-5 overflow-x-scroll p-10 snap-mandatory snap-x items-center justify-center">
            ...
            <article className="bg-genetec flex flex-col rounded-lg items-center space-y-5 flex-shrink-0 snap-center overflow-hidden opacity-100">
               <div className="px-0 md:px-10 unselectable z-10">
                  <h4 className="cursive overflow-hidden text-4xl text-blue-500">Software Tester</h4>
                  <p className="font-bold text-blue-400 text-3xl mt-1">Genetec</p>
                  <div>
                    <img src={process.env.PUBLIC_URL + '/Images/csharp.png'} alt="C#" className="rounded-lg w-6 h-6 float-left "/>
                    <img src={process.env.PUBLIC_URL + '/Images/powershell.png'} alt="Powershell" className="rounded-lg w-6 h-6 float-left"/>
                  </div>
